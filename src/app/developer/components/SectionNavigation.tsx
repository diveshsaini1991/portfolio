...
export default function SectionNavigation({ activeSection, onSectionChange }: SectionNavigationProps) {
  ...
  return (
    <div className="bg-gray-800/30 border-b border-gray-700 px-3 sm:px-4 md:px-6 py-2 sm:py-3">
      <div className="flex items-center gap-1.5 sm:gap-2 overflow-x-auto pb-1 scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-gray-800">
        <span className="text-[10px] sm:text-xs text-gray-500 mr-1 sm:mr-2 whitespace-nowrap flex-shrink-0">SECTIONS:</span>
